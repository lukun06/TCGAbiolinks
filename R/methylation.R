...
TCGAanalyze_survival <- function(data,
    ...
    if(!is.null(filename)) {
        ...
        if(risk.table){
            ...
            g <- gtable_rbind(g1[, 1:min_ncol], g2[, 1:min_ncol], size="last")
